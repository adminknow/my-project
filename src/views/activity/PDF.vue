...
<template>
    <div>
        <breadcrumb-component :title="'学习资料'"></breadcrumb-component>
        <div class="container">
            <div class="search">
                <el-row>
                    <el-col :span="24">
            ...
            <el-table :data="tableData" border style="width: 100%" :loading="loading"
                ...
                <el-table-column prop="FileTitle" align="center" label="主标题"></el-table-column>
                <el-table-column prop="FileDesc" align="center" label="副标题"></el-table-column>
                    ...
                    <template #default="scope">
                        <div class="btn-css">
                            ...
                            <el-button @click="handleEnable(scope.row.ResponseID)"
                                ...
                                text>启用</el-button>
                            <el-button @click="handleDelete(scope.row.ResponseID)" size="small" type="primary"
                                text>删除</el-button>
                        </div>
...
const SearchVideoResponsesApi = async () => {
    ...
    loading.value = true;
    const res = await SearchFileResponses({
    ...
    if (res.Code == 200) {
        ...
        pagination.pageTotal = res.DataMap.length > 0 ? res.DataMap[0].DataCount : 0;
    }
}
