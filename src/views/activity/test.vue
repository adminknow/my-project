...
<template>
    <div>
        <breadcrumb-component :title="'考试'"></breadcrumb-component>
        <div class="container">
            <div class="search">
                <el-row>
                    <el-col :span="24">
            ...
            <el-table :data="tableData" border style="width: 100%" :loading="loading"
                ...
                <el-table-column prop="ExamTitle" align="center" label="标题"></el-table-column>
                ...
                <el-table-column align="center" label="记录参加人数" width="160">
                    <template #default="scope">
                        <div class="left_align">{{ scope.row.Ext_TotalTestStaffCount }}</div>
                    </template>
                </el-table-column>
                ...
                <el-table-column align="center" label="操作" width="160">
                    <template #default="scope">
                        <div class="btn-css" style="">
                            ...
                            <el-button text size="small" type="primary"
                                @click="miniProgramView(scope.row.ExamID)">发送考试通知</el-button>
                            <el-button text size="small" type="primary"
                                @click="miniProgramView(scope.row.ExamID)">考试名单</el-button>
                            <el-button text size="small" type="primary"
                                @click="miniProgramView(scope.row.ExamID)">考试名单留底</el-button>
                        </div>
                    </template>
                </el-table-column>
            </el-table>
