...
<template>
    <div>
        ...
        <!-- 公司编辑与查看组件 -->
        <company-component :unitID="unitID" :unitType="SearchCondition.unit_type" :visible="companyVisible"
            @closeVisible="closeCompanyVisible" ref="companyComponentRef" />
    </div>
</template>
<script setup>
...
import companyComponent from "@/components/basic/company.vue";
import { Search, Plus, DocumentAdd } from '@element-plus/icons-vue'
import { ref, reactive, watch } from "vue";
import { SearchUnits } from "@/api/common.js";
import { useCompanyExport } from "@/hooks/use-export.js";
...
watch(
    ...
    (data) => {
        if (data.meta.title == "公司（调查问卷）" || data.meta.title == "公司") {
