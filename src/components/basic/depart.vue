            ...
            <el-row>
                <el-col :span="20">
                    <el-form-item label="所属公司">
                        <el-select v-model="form.ParentUnitID" filterable clearable placeholder="请选择所属公司">
                            <el-option v-for="item in unitItem" :key="item.UnitName" :label="item.UnitName"
                                :value="item.UnitID">
                            </el-option>
                        </el-select>
                    </el-form-item>
